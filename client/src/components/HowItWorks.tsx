...
const steps = [
  ...
  },
  {
    ...
    description:
      'Select your desired quality (Low, Medium, High) and download your transparent PNG.',
  },
];
        ...
        <div className="border-t border-b border-border py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {steps.map((step, index) => (
              ...
              >
                <div className="text-foreground/50 text-sm mb-3 font-medium">{step.number}</div>
